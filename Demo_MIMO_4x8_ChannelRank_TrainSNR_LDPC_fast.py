# Demo_MIMO_4x8_ChannelRank_TrainSNR_LDPC_fast.py
# --------------------------------------------------
# Faster run variant:
#  - FAST mode shrinks N, SNR grid, NumOfdmSymbols
#  - Decodes LDPC only every k-th data symbol (subsampling)
#  - Adaptive LDPC iterations & better LLRs with clipping
#  - Progress prints per SNR & symbol
#
# Saves both pre- and post-LDPC BER plots.
# --------------------------------------------------
...
outdir = "./results_block_fading_4x8_coded_uncode_12DB_train"
...
plt.title('4x8 MIMO | Pre-LDPC BER (code bits) | FAST')
...
if USE_LDPC and np.any(BERC_ESN_matched > 0):
    ...
    plt.title('4x8 MIMO | Post-LDPC BER | FAST')
    plt.tight_layout()
...
print(f" - {outdir}/BER_preLDPC_4x8_FAST.png")
print(f" - {outdir}/BER_postLDPC_4x8_FAST.png")
